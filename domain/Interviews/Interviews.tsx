...
const InterviewsPage = () => 
    <Column as="main">
        ...
        <Section asEl="div"  border="both" just="between" align="center" row variant="secondary" pad="1em">
            ...
            <Button lg to="https://accounts.karaconnect.com/auth/realms/kara/protocol/openid-connect/registrations?response_type=code&client_id=kara-acc-manage-fe&scope=openid&redirect_uri=https%3A%2F%2Fauth.karaconnect.com%2Fcreate-client%3Fview%3Dapply%26company_id%3D1115" margin="1em 4em 1em 0">Bóka viðtal</Button>
        </Section>
