    ...
    <ArticleSection title="Mæting í viðtal">
        <SubArticleSection title="Afbókanir">
            <Text>
                ...
                Hægt er að tilkynna afbókanir með því að senda póst á <Link inline lined to="mailto:endurnaering@endurnaering.is">endurnaering@endurnaering.is</Link>.
        ...
        <SubArticleSection title="Ábyrgð þín">
            <Text>
                ...
                <Link to="https://www.karaconnect.com/is" inline lined>Köru Connect</Link>.
