export default {
    ...
    services: {
        ...
        items: [
            { title: "Fullorðnir", content: ["Einstaklingsmiðuð næringarráðgjöf unnin út frá markmiðum og persónulegum áherslum."], to: "https://worldofwarcraft.com" },
            { title: "Börn og unglingar", content: ["Einstaklingsmiðuð næringarráðgjöf unnin út frá markmiðum og persónulegum áherslum í gegnum fjarfundarbúnað Köru Connect."], to: "https://worldofwarcraft.com" },
            { title: "Fyrirtæki", content: ["Næringarfræðingur kemur í heimsókn í fyrirtæki eða samkomur."], to: "https://worldofwarcraft.com" },
        ]
    },
    concepts: [
        { img: "/samtal.png", 
    ...
    references: {
        ...
        items: [
            ...
            { title: "Snilldarráðgjöf", content: ["Þetta var gargandi snilld. Ég gargaði alla leiðina heim eftir viðtalið."] },
