...
const Concepts = () => 
    <Section full col={2} center padVertical gaps>
        ...
        <Image cols={3} center src='/Naering.png' alt='næring-mynd' width={300} height={300} greenText></Image>
        <Article col={2} selfCenter>
            <Header2>Venjur</Header2>
            <Pg>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique aliquam itaque nobis, fuga animi ex nulla non aperiam eligendi expedita?</Pg>
        </Article>
        <Image cols={3} center src='/Venjur.png' alt='venjur-mynd' width={300} height={300} greenText></Image>
        <Article col={2} selfCenter>
            <Header2>Innsæi</Header2>
            <Pg>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Similique aliquam itaque nobis, fuga animi ex nulla non aperiam eligendi expedita?</Pg>
        </Article>
        <Image cols={3} center src='/Innsaei.png' alt='innsaei-mynd' width={300} height={300} greenText></Image>
    </Section>
