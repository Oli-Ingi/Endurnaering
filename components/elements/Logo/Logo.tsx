...
const StLink = styled.a<Props>`
    background-color: ${p => p.variant === "transparent" ? undefined : p.theme.colors.primary};
    ...
    svg {
        ...
        path, circle, rect {
            fill: ${p => p.theme.colors[p.variant === "transparent" ? "primary" : "white"]};
        }
    }
`
...
const Logo: React.FC<Props> = props =>
    <StLink href="/" {...props}>
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 893.65 281.77" xmlSpace="preserve">
            <circle className="green" cx="853.11" cy="367.73" r="7.87"/>
            <g>
                <path d="M169.55,109.99h-0.01c-17.28,0-31.3,14.02-31.3,31.3v31.31h6.53v-31.79c0-13.69,11.09-24.78,24.77-24.78h0.01
                c13.68,0,24.77,11.09,24.77,24.78v31.79h6.53v-31.31C200.85,124.01,186.83,109.99,169.55,109.99z"/>
                <path d="M125.14,139.45c0-0.21-0.02-0.42-0.04-0.62h-0.01c0-0.03,0-0.06,0-0.08c-1.53-15.86-14.9-28.28-31.17-28.28
                ...
                <path d="M269.88,122.82c-5.7-7.77-14.89-12.82-25.27-12.82c-17.29,0-31.31,14.02-31.31,31.31s14.02,31.3,31.31,31.3
                ...
                <path d="M344.72,141.78c0,13.69-11.09,24.78-24.77,24.78h-0.01c-13.68,0-24.77-11.09-24.77-24.78v-31.79h-6.53v31.31
                c0,17.28,14.02,31.3,31.3,31.3h0.01c17.28,0,31.3-14.02,31.3-31.3v-31.31h-6.53V141.78z"/>
                <path d="M395.01,110c-17.27-0.01-31.3,14.01-31.3,31.3l0,31.31l6.53-0.01v-31.79c0-13.69,11.09-24.78,24.77-24.77
                l0.01-0.01c7,0,13.32,2.91,17.83,7.59l4.38-4.38C411.55,113.54,403.7,109.99,395.01,110L395.01,110z"/>
                <path d="M456.48,109.84c-17.29,0-31.31,14.02-31.31,31.31v31.3h15.74v-30.84c0-8.6,6.97-15.57,15.57-15.57
                ...
                <path d="M604.33,134.27h-0.03c-0.07-0.3-0.12-0.6-0.2-0.89c-3.5-13.48-15.74-23.43-30.31-23.43
                ...
                <path d="M612.96,141.26l0,31.3h15.74v-30.84c0-8.6,6.97-15.57,15.57-15.57c4.16,0,7.92,1.63,10.71,4.28l11.36-11.36
                c-5.65-5.62-13.46-9.11-22.08-9.11C626.98,109.94,612.96,123.97,612.96,141.26z"/>
                <path  d="M729.11,109.95c-17.29,0-31.31,14.02-31.31,31.31v31.3h15.74v-30.84c0-8.6,6.97-15.57,15.57-15.57
                c4.3,0,8.19,1.74,11.01,4.56c2.82,2.82,4.56,6.71,4.56,11.01v30.84h15.73v-31.3c0-8.64-3.5-16.47-9.17-22.14
                C745.58,113.46,737.75,109.95,729.11,109.95z"/>
                <path  d="M820.28,164.87c6.59-5.74,10.76-14.19,10.76-23.62c0-17.29-14.01-31.3-31.3-31.3
                ...
                <rect x="674.21" y="109.95" width="15.73" height="62.61"/>
                <path className="logo-leaf" d="M681.95,94.11c0.09-0.69,0.13-1.4,0.13-2.11c0-10.35-8.39-18.74-18.74-18.74c-3.54,0-6.85,0.98-9.68,2.69
                C658.61,86.63,669.41,94.06,681.95,94.11z"/>
                <path className="logo-leaf" d="M705.83,83.2c-2.47-2.94-6.18-4.82-10.32-4.82c-7.42,0-13.43,6.01-13.43,13.43c0,0.78,0.07,1.55,0.2,2.3
