...
const StLink = styled.a<{ bgPrimary?: boolean, height?: number }>`
    background-color: ${p => p.bgPrimary ? p.theme.colors.primary : 'transparent'};
    height: ${p => p.height ? p.height + 'px' : '70px'};
    display: inline-block;
    text-align: center;
`

const Svg = styled.svg<{ bgPrimary?: boolean }>`
    height: 100%;

    path, circle, rect {
        fill: ${p => !p.bgPrimary ? p.theme.colors.primary : p.theme.colors.white};
    }
`
